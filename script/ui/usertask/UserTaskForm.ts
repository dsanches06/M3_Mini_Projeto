 ...
 */
export default function createAndAppendTaskForm(containerId: string, user: User, gestUserTask: GestUserTask): void {
 ...
 */
const handleFormSubmit = (event: Event, user: User, gestUserTask: GestUserTask): void => {
    ...
    const category = (form.querySelector('#taskCategory') as HTMLSelectElement).value;
