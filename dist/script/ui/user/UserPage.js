...
import { countAtiveInativePercentage, countAtiveUsers, countUnableUsers, countAllUsers, } from "./UserCountersUI.js";
...
export default function loadUsersPage(gestUserTask) {
    ...
    //
    showUsersCounters(gestUserTask.users, "utilizadores");
    //
