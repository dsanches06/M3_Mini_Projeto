...
import { allUsersTasks, pendingTasks, completedTasks, sortTasksByTitle, searchTasksByTitle, removeAllCompletedTask, } from "../gestUserTask/GestTaskUI.js";
...
import { countAllTasks, countCompletedUserTasks, countPendingUserTasks, } from "./TaskCountersUI.js";
    ...
    if (removeAllCompletedTaskBtn) {
        removeAllCompletedTaskBtn.addEventListener("click", () => {
            ...
            if (removedTasks.length > 0) {
                const completedTaskCount = removedTasks.filter((task) => task.getCompleted()).length;
